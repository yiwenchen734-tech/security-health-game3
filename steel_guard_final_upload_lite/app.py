...
LEVELS = [
    ...
    },
    {
        ...
        "options": [
            ...
            {
                "text": "🛡️放鬆肩膀、慢慢吐氣，雙腳重心交替，讓身體保持彈性。",
                "correct": True,
                "damage": 0,
                "sense": 8,
                "recovery": 10,
    ...
    },
    {
        ...
        "options": [
            {
                "text": "🛡️設定短暫活動提醒，起身走動、補水、做 30 秒伸展。",
                "correct": True,
                "damage": 0,
                "sense": 8,
                "recovery": 12,
...
if st.session_state.screen == "start":
    ...
    <div class='story-box'>
        ...
        <p>你的任務：撐過夜班危機 12 小時，在下班前蒐集護體戰技，降低職業傷害風險。</p>
    </div>
    """, unsafe_allow_html=True)
